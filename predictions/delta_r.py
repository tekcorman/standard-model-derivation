...
# in σ_PDG it remains ≫1σ (M_Z is 2.3 ppm). This residual is a CONFIRMED
# forced substrate-vs-SM oblique difference (~4% relative), NOT a clean
# close: the next term (the shell vertex/box, the Q-winding non-singlet),
# BZ-integrated over the Brillouin zone, supplies only 0.205× its Γ-point
# template value — the Γ "bracket" (δ_r under / Γ-shell over) was a
# high-symmetry-point evaluation artifact (Γ is the BZ maximum of the
# spectral functional F=Im h/|h|²). So the substrate under-predicts the EW
# oblique by ~4%; the Perron-only δ_r is the forced single-term prediction
# and the +8.1σ residual does NOT zero out under any forced next term.
