...
Step 6 — Factor 2 = dim_ℂ(min. faithful rep of Cl(0,2)):
  ...
  Family D (LAYER-1 HYPOTHESIS): per-Higgs-leg dark disruption rate
  ...
  Per master doc §8 rule 6, hypothesis-grade Family D NOT propagated to
  the numerical prediction here. λ remains 2560/19683 until Routes H + C
  for c_H = α₁² close.
