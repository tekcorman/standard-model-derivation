...
> **INCONSISTENCY FLAG (2026-06-11 Majorana-sector panel; value unchanged
> while preregistration row 8 stands frozen):** 2g·arg(h) = (φ_ω − φ_ω²) mod
> 360 is the generation-2-vs-3 relative phase under the adoption's own form;
> the adoption-consistent α₃₁ = φ₃ − φ₁ = arg(h_ω²^g) = 197.612°. Two in-repo
> conventions conflict; with m₁ = 0 only one combination is physical
> (|α₃₁ − α₂₁| = 35.225° adoption-consistent). See the preregistration
> register, Annotations 2026-06-11 (row-8 consistency defect).
