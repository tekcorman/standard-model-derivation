...
**Date:** 2026-04-19 (initial); updated 2026-04-22 (session 18: dark correction 5/12 closed); updated 2026-04-22 (session 19: the observable used to calibrate N_hub's value changed from H_0 to G_F — N_hub is the adopted input either way).
...
MDL also selects the critical-point potential (mu^2 = 0) over the full
Landau-Ginzburg potential, by a compression-ratio factor R >= 2.88 × 10^6.
...
expectation value v = <|Phi|> is the mean-field model. No perturbative
fluctuation correction reduces total description length.
...
### Step 4: MDL Selects the Critical Point (mu^2 = 0)
...
The BZJ formula (Step 3) is therefore the MDL-correct effective theory.

**Grade:** STRICT-SOLID under A2 (N-cancellation is exact; R_mu^2 >= 2.88e6
holds for all N >= 2).
