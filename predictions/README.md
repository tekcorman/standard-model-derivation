...
> predating 2026-06-25 may quote the BARE heavy-quark anchors (m_t 174.10 GeV, m_b 4.270 GeV, and
> chains anchored on them, e.g. m_c/m_u/m_s/m_d) — the live predictions apply the forced dark
> self-energy correction Σ = α₁/h shipped that date (`heavy_quark_anchor_dark.py`,
> `docs/theorems/theorem_dark_self_energy_unified_2026-06-28.md`; m_t/m_b's own write-ups carry
> update banners). Where a doc and its `.py` disagree, the `.py` + lock file win.
...
```bash
python3 verify.py                              # backbone proof suite (65 proofs, ~60s)
