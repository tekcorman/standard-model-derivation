...
| Term | Meaning |
|---|---|
| **srs** | The Laves / (10,3)-a crystal net; the MDL-dominant substrate — the dominant member of the waterline survivor set {srs, srs-c8, lou, lov} (R-9 supersession 2026-06-15; Sunada 2012 supplies the classification landscape). Space group I4₁32, $k_* = 3$, girth $g = 10$. |
...
| **R-9** | The substrate-selection question. The 2026-05-12 "forced uniquely via Sunada" closure was superseded 2026-06-15: the operative closure is the RCSR structural-fingerprint study — srs is DOMINANT among the waterline survivors, not uniquely selected; the data-free discriminator is a logged open equation. |
