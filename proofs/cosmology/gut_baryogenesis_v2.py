...
g = 10                                  # Laves girth
# Cycle decomposition (verified 2026-05-03 in
# proofs/foundations/srs_ten_cycle_chirality_split.py):
# 9 chiral + 6 P-symmetric ten-cycles per vertex. The 6 are reflection-invariant
# (signed projected area = 0), NOT opposite-handed. The asymmetry value 1/5 is
# preserved; mechanism reading is "chiral vs P-symmetric" (was "CCW vs CW").
n_chiral, n_psym = 9, 6                # ten-cycles per vertex
epsilon_topo = (n_chiral - n_psym) / (n_chiral + n_psym)  # = 1/5
