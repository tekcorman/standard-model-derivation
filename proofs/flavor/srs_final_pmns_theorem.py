...
#
# Using the framework BARE V_us = (2/3)^(2+sqrt(3)) (no Feshbach/dark
# correction at this layer; matches srs_theta12_perp.py 2026-04-15),
# we get theta_12 = 33.17 deg with pull -0.36 sigma.
V_us_bare_for_perp = V_us  # already = (2/3)**L_us above; bare framework value
theta_C_perp_rad = math.asin(V_us_bare_for_perp)
