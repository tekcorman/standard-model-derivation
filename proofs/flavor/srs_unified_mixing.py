...
#
# *** STALE-CHAIN FLAG (2026-06-11 Majorana-sector panel): this section uses
# *** delta_CP = 249.851 deg (the RETIRED Hashimoto-phase route, falsified
# *** 2026-05-02; superseded by the frozen 180 deg, preregistration row 1),
# *** alpha_31 = 197.612 deg (contradicting frozen row 8 = 324.775), and
# *** observed NuFIT masses rather than the frozen rows 4/5. Its ~2.55 meV
# *** output MUST NOT be cited as the row-9 chain pending reconciliation;
# *** register-consistent recomputation from frozen rows gives ~1.5 meV.
# *** See preregistration register, Annotations 2026-06-11.
# ══════════════════════════════════════════════════════════════════════════
