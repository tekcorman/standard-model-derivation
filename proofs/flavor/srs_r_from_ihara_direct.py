...
derivation. This script is the historical NB-walk / Bloch-Hashimoto derivation
that gave R ~ 32.19 (B+ -> A-). The correct theorem-grade derivation is
...
q = k*-1 = 2. See docs/parameters/R_theorem.md. This script is retained for historical
