...
| **archive-only** | 247 | Cited *only* by archived docs (internal working notes, `predictions/retracted/`). Backed work since archived — likely superseded; treat as historical unless re-verified. |
...
Any doc hit outside internal working notes — **current**. Hits only inside those — **archive-only**. No doc hits
