...
⚠ SUPERSEDED 2026-06-29 (Need-D-3 DISSOLVED, not blocked): this M2 program assumes the CKM
is the mass-eigenstate DIAGONALIZATION mismatch (V_uL†V_dL). That mismatch is forced-TRIVIAL
(V=I — the run co-diagonalizes generations on the C₃-fixed axis; a RED HERRING). The ACTUAL
CKM = the OFF-DIAGONAL elements of G_NB directly (substrate walk): V_us=9/40, V_cb=256/6305,
V_ub theorem-grade, all in verify.py; level-structure forced by
theorem_A5b_level_selection_from_recurrence_2026-06-22. So M2.3's "mass-eigenstate
identification" is NOT the CKM bottleneck. See RESTART §6 + documentation_lag_contradictions §3.
(Kept as the historical M2-program record.)
