...
except ImportError:  # plotting optional; proofs must run on bare numpy/scipy/sympy
    plt = None
...
def plot_all(ts_GP, E_GP, labels_P, E_by_label,
    ...
    """Generate all plots."""
    if plt is None:
        print("[plot_all] matplotlib not available — skipping plots (proof results unaffected)")
        return
