...
> **⚑ 2026-07-01 status note — conditions 1–3 are substantially MET.** The 2026-06-23 consolidation
> (`derivation_topdown/bridge/the_run.py`: one object D = B(srs⊗srs-z) ⊗ ∂_N; masses = the
> resolvent's diagonal, mixings = off-diagonal, gauge running = the ∂_N zero-mode) met condition 1
> (universal mass operator) and condition 3 (the mass sector forced into the same resolvent as the
> oblique/CKM family — the m_t/m_b closures of 2026-06-25 came from the resolvent's own
> first-girth-return with zero new input); condition 2 (selection map as theorem) was met 2026-05-21.
> **Condition 4 (MDL closure — zero input) is the live frontier**, open at exactly: the A5(b)
> derivation, the −70 ppm lepton subleading, ζ_{D₄}(0), the substrate-selection discriminator
> (R-9, re-ruled 2026-07-01: srs = dominant waterline survivor), and 2 substantive adoptions.
> Current open ledger: `incomplete_equations_todo.md`.
