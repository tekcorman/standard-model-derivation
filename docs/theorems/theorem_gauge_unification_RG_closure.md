...
| g_2(M_Z) | 0.65175 | 0.6520 | −2.52σ_PDG | FAIL *(superseded 2026-06-25: the 0.6520 target was scheme-inconsistent; vs the consistent MS̄ reference 0.65177 the same predicted value is **−0.18σ PASS** — see `predictions/g_2_derivation.md`)* |
