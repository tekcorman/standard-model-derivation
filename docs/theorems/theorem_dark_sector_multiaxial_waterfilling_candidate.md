...
The mode-axis Poisson(2k*) mechanism that gives `Ω_DM/Ω_m = 0.8488` (Row P22) is one facet of a deeper structural asymmetry the framework realises across two distinct derivation families. Making the asymmetry explicit unifies the 12-observable §8-family over-determination landing (`docs/state_of_the_lepton_pmns_over_determination_2026-05-23.md`) with the existing single-axis dark-sector mechanisms catalogued in §1 above.
...
(a) **It unifies the 12-observable §8 over-determination with the Ω_DM/Ω_m mechanism** under one structural picture. The 12 §8-family observables couple to luminous matter (they are readings of the compressed sector); Ω_DM is the mass-fraction of the uncompressed sector; both derive from the same compression boundary. Today's `state_of_the_lepton_pmns_over_determination_2026-05-23.md` becomes the gauge-side complement of the substrate-side Ω_DM derivation.
...
- `docs/state_of_the_lepton_pmns_over_determination_2026-05-23.md` — 12-observable §8-family condition-3 landing (gauge-side complement).
...
- `state_of_the_absolute_scale_2026-05-17.md` (Gap G1 characterisation).
