...
(`state_of_the_gen3_anchor_overdetermination_2026-05-22.md`) and the
2026-05-23 lepton/PMNS audit
(`state_of_the_lepton_pmns_over_determination_2026-05-23.md`,
...
**Cross-references:**
- `state_of_the_lepton_pmns_over_determination_2026-05-23.md` — the
  4-observable lepton/PMNS landing (parallel to this §9).
- `state_of_the_gen3_anchor_overdetermination_2026-05-22.md` — the
  original 2026-05-22 narrow quark-sector framing (since broadened).
- `state_of_2026-05-23.md` §2.5 — the consolidated 11-observable
