...
closed form. See [`R_theorem.md`](parameters/R_theorem.md) for the full derivation.
...
(see [derivations.md](parameters/derivations.md)).
...
This runs 65 backbone proofs in ~60 seconds. Each one derives a Standard Model 
quantity from the srs lattice with zero free parameters. All should PASS.

## If you have 30 minutes

Read [derivations.md](parameters/derivations.md) for the complete picture: how one complex 
...
- Not numerology. Every result has a derivation chain from three irreducible commitments — (A) self-containment, (B) finite observer, (I) active reading — plus one empirical labeling rule (A5-mass). See [honest_assessment.md](honest_assessment.md).
- Not complete. Several cosmology precision items (n_s, σ_8, r_s, θ_*) and the absolute N_hub derivation remain genuinely open at theorem grade. See [honest_assessment.md](honest_assessment.md) "What is NOT derived" for the full boundary.
