...
The substrate-derived matter content is 3 PS generations + 2 Higgs doublets, with no superpartners (Cl(6) Fock all-fermionic per Path-E recheck 2026-05-12; A1 thermal-apparatus closure 2026-05-27). The MSSM β-coefficient values (33/5, 1, −3) that the framework predicts are derived by algebraic inversion from PDG α_i(M_Z) under α_GUT⁻¹ = 24 ([`theorem_beta_coefficients_derived.md`](../theorems/theorem_beta_coefficients_derived.md), mathematically complete, 2026-05-14).
