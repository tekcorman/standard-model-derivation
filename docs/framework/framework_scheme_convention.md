...
### 4.3 Higgs quartic λ — Feshbach analog NOT YET DERIVED
...
### 4.4 y_τ — Feshbach analog status open
...
- Cosmological observables (Λ, H_0, t_0). These have their own scope (an internal working note, an internal working note).
